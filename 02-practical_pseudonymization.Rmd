...
datadict::k_anonymity(dat, vars_indirect, threshold = 5)
```
...
```{r}
datadict::k_anonymity(dat, c("sex", "age_group"), threshold = 5)
datadict::k_anonymity(dat, c("sex", "age_group", "location"), threshold = 5)
datadict::k_anonymity(dat, c("sex", "age_group", "source_water"), threshold = 5)
```
...
datadict::k_anonymity(dat, c("sex", "age_group", "water_source_agg"), threshold = 5)
```
